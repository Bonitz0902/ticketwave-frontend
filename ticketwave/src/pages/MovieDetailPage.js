...
export const MovieDetailPage = () => {
    ...
    return (
        <div className={"movieDetails"}>
            <h3>Movie Details</h3>
            <center><Image width={250} src={"https://dunenewsnet.com/wp-content/uploads/2021/08/Dune-Movie-Official-Poster-banner-feature-770x364.jpg"}/></center>
            <h4>DUNE : Part One</h4>
            ...
            <center><Button type={"primary"}> Book Now </Button></center>
        </div>
    );
}